...
def load_dataset(path, tableName):
    ...
    try:
        ...
        sys.stderr.write("Connect Error: unable to start thread (" + str(e) + ")")
...
if __name__ == '__main__':
    ...
    #Data integration
    sys.stderr.write("Processing data files:")
    ...
    csv = new[['NumOfReceived','PRR','packetLoss','PLR','throughput', 'IPI', 'Density']].to_csv(None, sep=',', index=False)
    print(csv)
